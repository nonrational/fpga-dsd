...
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { DIP1 }]; #IO_L20P_T3_34 Sch=ck_io[32]
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { DIP0 }]; #IO_L20N_T3_34 Sch=ck_io[33]
